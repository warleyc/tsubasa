...
/**
 * A MActionSkillHolderCardCt.
 */
@Entity
@Table(name = "m_action_skill_holder_card_ct")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MActionSkillHolderCardCt implements Serializable {
    ...
    @NotNull
    @JsonIgnoreProperties("mActionSkillHolderCardCts")
    ...
    public MActionSkillHolderCardCt targetCharaId(Integer targetCharaId) {
    ...
    public MActionSkillHolderCardCt actionMasterId(Integer actionMasterId) {
    ...
    public MActionSkillHolderCardCt actionSkillExp(Integer actionSkillExp) {
    ...
    public MActionSkillHolderCardCt name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MActionSkillHolderCardCt description(String description) {
    ...
    public MActionSkillHolderCardCt id(MCharacter mCharacter) {
        this.id = mCharacter;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MActionSkillHolderCardCt)) {
            return false;
        }
        return id != null && id.equals(((MActionSkillHolderCardCt) o).id);
    }
