 ...
 */
@Entity
@Table(name = "m_advent_quest_stage")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MAdventQuestStage implements Serializable {
    ...
    public MAdventQuestStage worldId(Integer worldId) {
    ...
    public MAdventQuestStage number(Integer number) {
        this.number = number;
        return this;
    }
    ...
    public MAdventQuestStage name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MAdventQuestStage imagePath(String imagePath) {
    ...
    public MAdventQuestStage characterThumbnailPath(String characterThumbnailPath) {
    ...
    public MAdventQuestStage difficulty(Integer difficulty) {
    ...
    public MAdventQuestStage stageUnlockPattern(Integer stageUnlockPattern) {
    ...
    public MAdventQuestStage storyOnly(Integer storyOnly) {
    ...
    public MAdventQuestStage firstHalfNpcDeckId(Integer firstHalfNpcDeckId) {
    ...
    public MAdventQuestStage firstHalfEnvironmentId(Integer firstHalfEnvironmentId) {
    ...
    public MAdventQuestStage secondHalfNpcDeckId(Integer secondHalfNpcDeckId) {
    ...
    public MAdventQuestStage secondHalfEnvironmentId(Integer secondHalfEnvironmentId) {
    ...
    public MAdventQuestStage extraFirstHalfNpcDeckId(Integer extraFirstHalfNpcDeckId) {
    ...
    public MAdventQuestStage extraSecondHalfNpcDeckId(Integer extraSecondHalfNpcDeckId) {
    ...
    public MAdventQuestStage consumeAp(Integer consumeAp) {
    ...
    public MAdventQuestStage kickOffType(Integer kickOffType) {
    ...
    public MAdventQuestStage matchMinute(Integer matchMinute) {
    ...
    public MAdventQuestStage enableExtra(Integer enableExtra) {
    ...
    public MAdventQuestStage enablePk(Integer enablePk) {
    ...
    public MAdventQuestStage aiLevel(Integer aiLevel) {
    ...
    public MAdventQuestStage startAtSecondHalf(Integer startAtSecondHalf) {
    ...
    public MAdventQuestStage startScore(Integer startScore) {
    ...
    public MAdventQuestStage startScoreOpponent(Integer startScoreOpponent) {
    ...
    public MAdventQuestStage conditionId(Integer conditionId) {
    ...
    public MAdventQuestStage optionId(Integer optionId) {
    ...
    public MAdventQuestStage deckConditionId(Integer deckConditionId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MAdventQuestStage)) {
            return false;
        }
        return id != null && id.equals(((MAdventQuestStage) o).id);
    }
