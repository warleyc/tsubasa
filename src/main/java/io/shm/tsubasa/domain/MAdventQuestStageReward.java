...
/**
 * A MAdventQuestStageReward.
 */
@Entity
@Table(name = "m_advent_quest_stage_reward")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MAdventQuestStageReward implements Serializable {
    ...
    public MAdventQuestStageReward stageId(Integer stageId) {
    ...
    public MAdventQuestStageReward exp(Integer exp) {
        this.exp = exp;
        return this;
    }
    ...
    public MAdventQuestStageReward coin(Integer coin) {
        this.coin = coin;
        return this;
    }
    ...
    public MAdventQuestStageReward guildPoint(Integer guildPoint) {
    ...
    public MAdventQuestStageReward clearRewardGroupId(Integer clearRewardGroupId) {
    ...
    public MAdventQuestStageReward clearRewardWeightId(Integer clearRewardWeightId) {
    ...
    public MAdventQuestStageReward achievementRewardGroupId(Integer achievementRewardGroupId) {
    ...
    public MAdventQuestStageReward coopGroupId(Integer coopGroupId) {
    ...
    public MAdventQuestStageReward specialRewardGroupId(Integer specialRewardGroupId) {
    ...
    public MAdventQuestStageReward specialRewardAmount(Integer specialRewardAmount) {
    ...
    public MAdventQuestStageReward goalRewardGroupId(Integer goalRewardGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MAdventQuestStageReward)) {
            return false;
        }
        return id != null && id.equals(((MAdventQuestStageReward) o).id);
    }
