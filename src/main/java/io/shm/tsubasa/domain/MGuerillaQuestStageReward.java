...
/**
 * A MGuerillaQuestStageReward.
 */
@Entity
@Table(name = "m_guerilla_quest_stage_reward")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MGuerillaQuestStageReward implements Serializable {
    ...
    public MGuerillaQuestStageReward stageId(Integer stageId) {
    ...
    public MGuerillaQuestStageReward exp(Integer exp) {
        this.exp = exp;
        return this;
    }
    ...
    public MGuerillaQuestStageReward coin(Integer coin) {
        this.coin = coin;
        return this;
    }
    ...
    public MGuerillaQuestStageReward guildPoint(Integer guildPoint) {
    ...
    public MGuerillaQuestStageReward clearRewardGroupId(Integer clearRewardGroupId) {
    ...
    public MGuerillaQuestStageReward clearRewardWeightId(Integer clearRewardWeightId) {
    ...
    public MGuerillaQuestStageReward achievementRewardGroupId(Integer achievementRewardGroupId) {
    ...
    public MGuerillaQuestStageReward coopGroupId(Integer coopGroupId) {
    ...
    public MGuerillaQuestStageReward specialRewardGroupId(Integer specialRewardGroupId) {
    ...
    public MGuerillaQuestStageReward specialRewardAmount(Integer specialRewardAmount) {
    ...
    public MGuerillaQuestStageReward goalRewardGroupId(Integer goalRewardGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MGuerillaQuestStageReward)) {
            return false;
        }
        return id != null && id.equals(((MGuerillaQuestStageReward) o).id);
    }
