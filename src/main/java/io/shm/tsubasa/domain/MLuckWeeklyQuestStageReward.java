...
/**
 * A MLuckWeeklyQuestStageReward.
 */
@Entity
@Table(name = "m_luck_weekly_quest_stage_reward")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MLuckWeeklyQuestStageReward implements Serializable {
    ...
    public MLuckWeeklyQuestStageReward stageId(Integer stageId) {
    ...
    public MLuckWeeklyQuestStageReward exp(Integer exp) {
        this.exp = exp;
        return this;
    }
    ...
    public MLuckWeeklyQuestStageReward coin(Integer coin) {
        this.coin = coin;
        return this;
    }
    ...
    public MLuckWeeklyQuestStageReward guildPoint(Integer guildPoint) {
    ...
    public MLuckWeeklyQuestStageReward clearRewardGroupId(Integer clearRewardGroupId) {
    ...
    public MLuckWeeklyQuestStageReward clearRewardWeightId(Integer clearRewardWeightId) {
    ...
    public MLuckWeeklyQuestStageReward achievementRewardGroupId(Integer achievementRewardGroupId) {
    ...
    public MLuckWeeklyQuestStageReward coopGroupId(Integer coopGroupId) {
    ...
    public MLuckWeeklyQuestStageReward specialRewardGroupId(Integer specialRewardGroupId) {
    ...
    public MLuckWeeklyQuestStageReward specialRewardAmount(Integer specialRewardAmount) {
    ...
    public MLuckWeeklyQuestStageReward goalRewardGroupId(Integer goalRewardGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MLuckWeeklyQuestStageReward)) {
            return false;
        }
        return id != null && id.equals(((MLuckWeeklyQuestStageReward) o).id);
    }
