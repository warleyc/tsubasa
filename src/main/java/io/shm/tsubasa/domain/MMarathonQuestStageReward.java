...
/**
 * A MMarathonQuestStageReward.
 */
@Entity
@Table(name = "m_marathon_quest_stage_reward")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MMarathonQuestStageReward implements Serializable {
    ...
    public MMarathonQuestStageReward stageId(Integer stageId) {
    ...
    public MMarathonQuestStageReward exp(Integer exp) {
        this.exp = exp;
        return this;
    }
    ...
    public MMarathonQuestStageReward coin(Integer coin) {
        this.coin = coin;
        return this;
    }
    ...
    public MMarathonQuestStageReward guildPoint(Integer guildPoint) {
    ...
    public MMarathonQuestStageReward clearRewardGroupId(Integer clearRewardGroupId) {
    ...
    public MMarathonQuestStageReward clearRewardWeightId(Integer clearRewardWeightId) {
    ...
    public MMarathonQuestStageReward achievementRewardGroupId(Integer achievementRewardGroupId) {
    ...
    public MMarathonQuestStageReward coopGroupId(Integer coopGroupId) {
    ...
    public MMarathonQuestStageReward specialRewardGroupId(Integer specialRewardGroupId) {
    ...
    public MMarathonQuestStageReward specialRewardAmount(Integer specialRewardAmount) {
    ...
    public MMarathonQuestStageReward goalRewardGroupId(Integer goalRewardGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MMarathonQuestStageReward)) {
            return false;
        }
        return id != null && id.equals(((MMarathonQuestStageReward) o).id);
    }
