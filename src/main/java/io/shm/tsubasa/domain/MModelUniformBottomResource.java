...
/**
 * A MModelUniformBottomResource.
 */
@Entity
@Table(name = "m_model_uniform_bottom_resource")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MModelUniformBottomResource implements Serializable {
    ...
    public MModelUniformBottomResource uniformTypeId(Integer uniformTypeId) {
    ...
    public MModelUniformBottomResource dressingType(Integer dressingType) {
    ...
    public MModelUniformBottomResource width(Integer width) {
        this.width = width;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MModelUniformBottomResource)) {
            return false;
        }
        return id != null && id.equals(((MModelUniformBottomResource) o).id);
    }
