 ...
 */
@Entity
@Table(name = "m_quest_stage")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MQuestStage implements Serializable {
    ...
    @NotNull
    @JsonIgnoreProperties("mQuestStages")
    ...
    public MQuestStage worldId(Integer worldId) {
    ...
    public MQuestStage number(Integer number) {
        this.number = number;
        return this;
    }
    ...
    public MQuestStage name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MQuestStage imagePath(String imagePath) {
    ...
    public MQuestStage characterThumbnailPath(String characterThumbnailPath) {
    ...
    public MQuestStage difficulty(Integer difficulty) {
    ...
    public MQuestStage stageUnlockPattern(Integer stageUnlockPattern) {
    ...
    public MQuestStage storyOnly(Integer storyOnly) {
    ...
    public MQuestStage firstHalfNpcDeckId(Integer firstHalfNpcDeckId) {
    ...
    public MQuestStage firstHalfEnvironmentId(Integer firstHalfEnvironmentId) {
    ...
    public MQuestStage secondHalfNpcDeckId(Integer secondHalfNpcDeckId) {
    ...
    public MQuestStage secondHalfEnvironmentId(Integer secondHalfEnvironmentId) {
    ...
    public MQuestStage extraFirstHalfNpcDeckId(Integer extraFirstHalfNpcDeckId) {
    ...
    public MQuestStage consumeAp(Integer consumeAp) {
    ...
    public MQuestStage kickOffType(Integer kickOffType) {
    ...
    public MQuestStage matchMinute(Integer matchMinute) {
    ...
    public MQuestStage enableExtra(Integer enableExtra) {
    ...
    public MQuestStage enablePk(Integer enablePk) {
    ...
    public MQuestStage aiLevel(Integer aiLevel) {
    ...
    public MQuestStage startAtSecondHalf(Integer startAtSecondHalf) {
    ...
    public MQuestStage startScore(Integer startScore) {
    ...
    public MQuestStage startScoreOpponent(Integer startScoreOpponent) {
    ...
    public MQuestStage conditionId(Integer conditionId) {
    ...
    public MQuestStage optionId(Integer optionId) {
    ...
    public MQuestStage deckConditionId(Integer deckConditionId) {
    ...
    public MQuestWorld getMquestworld() {
        return mquestworld;
    }

    public MQuestStage mquestworld(MQuestWorld mQuestWorld) {
        this.mquestworld = mQuestWorld;
        return this;
    }

    public void setMquestworld(MQuestWorld mQuestWorld) {
        this.mquestworld = mQuestWorld;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MQuestStage)) {
            return false;
        }
        return id != null && id.equals(((MQuestStage) o).id);
    }
