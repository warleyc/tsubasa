...
/**
 * A MTicketQuestStageReward.
 */
@Entity
@Table(name = "m_ticket_quest_stage_reward")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MTicketQuestStageReward implements Serializable {
    ...
    public MTicketQuestStageReward stageId(Integer stageId) {
    ...
    public MTicketQuestStageReward exp(Integer exp) {
        this.exp = exp;
        return this;
    }
    ...
    public MTicketQuestStageReward coin(Integer coin) {
        this.coin = coin;
        return this;
    }
    ...
    public MTicketQuestStageReward guildPoint(Integer guildPoint) {
    ...
    public MTicketQuestStageReward clearRewardGroupId(Integer clearRewardGroupId) {
    ...
    public MTicketQuestStageReward clearRewardWeightId(Integer clearRewardWeightId) {
    ...
    public MTicketQuestStageReward achievementRewardGroupId(Integer achievementRewardGroupId) {
    ...
    public MTicketQuestStageReward coopGroupId(Integer coopGroupId) {
    ...
    public MTicketQuestStageReward specialRewardGroupId(Integer specialRewardGroupId) {
    ...
    public MTicketQuestStageReward specialRewardAmount(Integer specialRewardAmount) {
    ...
    public MTicketQuestStageReward goalRewardGroupId(Integer goalRewardGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MTicketQuestStageReward)) {
            return false;
        }
        return id != null && id.equals(((MTicketQuestStageReward) o).id);
    }
