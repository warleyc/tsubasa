 ...
 */
@Entity
@Table(name = "m_ticket_quest_world")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MTicketQuestWorld implements Serializable {
    ...
    public MTicketQuestWorld setId(Integer setId) {
        this.setId = setId;
        return this;
    }
    ...
    public MTicketQuestWorld number(Integer number) {
        this.number = number;
        return this;
    }
    ...
    public MTicketQuestWorld name(String name) {
        this.name = name;
        return this;
    }
    ...
    public MTicketQuestWorld imagePath(String imagePath) {
    ...
    public MTicketQuestWorld description(String description) {
    ...
    public MTicketQuestWorld stageUnlockPattern(Integer stageUnlockPattern) {
    ...
    public MTicketQuestWorld specialRewardContentType(Integer specialRewardContentType) {
    ...
    public MTicketQuestWorld specialRewardContentId(Integer specialRewardContentId) {
    ...
    public MTicketQuestWorld isEnableCoop(Integer isEnableCoop) {
    ...
    public Integer getIsHideDoNotHavingTicket() {
        return isHideDoNotHavingTicket;
    }

    public MTicketQuestWorld isHideDoNotHavingTicket(Integer isHideDoNotHavingTicket) {
        this.isHideDoNotHavingTicket = isHideDoNotHavingTicket;
        return this;
    }

    public void setIsHideDoNotHavingTicket(Integer isHideDoNotHavingTicket) {
        this.isHideDoNotHavingTicket = isHideDoNotHavingTicket;
    }

    public Set<MTicketQuestStage> getMTicketQuestStages() {
        return mTicketQuestStages;
    }

    public MTicketQuestWorld mTicketQuestStages(Set<MTicketQuestStage> mTicketQuestStages) {
        this.mTicketQuestStages = mTicketQuestStages;
        return this;
    }
    ...
    public void setMTicketQuestStages(Set<MTicketQuestStage> mTicketQuestStages) {
        this.mTicketQuestStages = mTicketQuestStages;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MTicketQuestWorld)) {
            return false;
        }
        return id != null && id.equals(((MTicketQuestWorld) o).id);
    }
    ...
    public String toString() {
        return "MTicketQuestWorld{" +
            ...
            ", isHideDoNotHavingTicket=" + getIsHideDoNotHavingTicket() +
            "}";
    }
}
