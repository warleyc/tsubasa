...
/**
 * A MTimeattackQuestStageReward.
 */
@Entity
@Table(name = "m_timeattack_quest_stage_reward")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MTimeattackQuestStageReward implements Serializable {
    ...
    public MTimeattackQuestStageReward stageId(Integer stageId) {
    ...
    public MTimeattackQuestStageReward exp(Integer exp) {
        this.exp = exp;
        return this;
    }
    ...
    public MTimeattackQuestStageReward coin(Integer coin) {
        this.coin = coin;
        return this;
    }
    ...
    public MTimeattackQuestStageReward guildPoint(Integer guildPoint) {
    ...
    public MTimeattackQuestStageReward clearRewardGroupId(Integer clearRewardGroupId) {
    ...
    public MTimeattackQuestStageReward clearRewardWeightId(Integer clearRewardWeightId) {
    ...
    public MTimeattackQuestStageReward achievementRewardGroupId(Integer achievementRewardGroupId) {
    ...
    public MTimeattackQuestStageReward coopGroupId(Integer coopGroupId) {
    ...
    public MTimeattackQuestStageReward specialRewardGroupId(Integer specialRewardGroupId) {
    ...
    public MTimeattackQuestStageReward specialRewardAmount(Integer specialRewardAmount) {
    ...
    public MTimeattackQuestStageReward goalRewardGroupId(Integer goalRewardGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MTimeattackQuestStageReward)) {
            return false;
        }
        return id != null && id.equals(((MTimeattackQuestStageReward) o).id);
    }
