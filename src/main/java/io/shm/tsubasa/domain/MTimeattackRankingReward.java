...
/**
 * A MTimeattackRankingReward.
 */
@Entity
@Table(name = "m_timeattack_ranking_reward")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MTimeattackRankingReward implements Serializable {
    ...
    public MTimeattackRankingReward eventId(Integer eventId) {
    ...
    public MTimeattackRankingReward rankingFrom(Integer rankingFrom) {
    ...
    public MTimeattackRankingReward rankingTo(Integer rankingTo) {
    ...
    public MTimeattackRankingReward rewardGroupId(Integer rewardGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MTimeattackRankingReward)) {
            return false;
        }
        return id != null && id.equals(((MTimeattackRankingReward) o).id);
    }
