...
/**
 * A MWeeklyQuestStageReward.
 */
@Entity
@Table(name = "m_weekly_quest_stage_reward")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class MWeeklyQuestStageReward implements Serializable {
    ...
    public MWeeklyQuestStageReward stageId(Integer stageId) {
    ...
    public MWeeklyQuestStageReward exp(Integer exp) {
        this.exp = exp;
        return this;
    }
    ...
    public MWeeklyQuestStageReward coin(Integer coin) {
        this.coin = coin;
        return this;
    }
    ...
    public MWeeklyQuestStageReward guildPoint(Integer guildPoint) {
    ...
    public MWeeklyQuestStageReward clearRewardGroupId(Integer clearRewardGroupId) {
    ...
    public MWeeklyQuestStageReward clearRewardWeightId(Integer clearRewardWeightId) {
    ...
    public MWeeklyQuestStageReward achievementRewardGroupId(Integer achievementRewardGroupId) {
    ...
    public MWeeklyQuestStageReward coopGroupId(Integer coopGroupId) {
    ...
    public MWeeklyQuestStageReward specialRewardGroupId(Integer specialRewardGroupId) {
    ...
    public MWeeklyQuestStageReward specialRewardAmount(Integer specialRewardAmount) {
    ...
    public MWeeklyQuestStageReward goalRewardGroupId(Integer goalRewardGroupId) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MWeeklyQuestStageReward)) {
            return false;
        }
        return id != null && id.equals(((MWeeklyQuestStageReward) o).id);
    }
