...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MActionSkillHolderCardContent} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MActionSkillHolderCardContentResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-action-skill-holder-card-contents?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MActionSkillHolderCardContentCriteria implements Serializable, Criteria {
    ...
    public MActionSkillHolderCardContentCriteria(){
    }

    public MActionSkillHolderCardContentCriteria(MActionSkillHolderCardContentCriteria other){
    ...
    @Override
    public MActionSkillHolderCardContentCriteria copy() {
        return new MActionSkillHolderCardContentCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MActionSkillHolderCardContentCriteria that = (MActionSkillHolderCardContentCriteria) o;
        return
    ...
    public String toString() {
        return "MActionSkillHolderCardContentCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
