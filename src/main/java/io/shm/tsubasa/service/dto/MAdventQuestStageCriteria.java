...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MAdventQuestStage} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MAdventQuestStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-advent-quest-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MAdventQuestStageCriteria implements Serializable, Criteria {
    ...
    public MAdventQuestStageCriteria(MAdventQuestStageCriteria other){
    ...
    @Override
    public MAdventQuestStageCriteria copy() {
        return new MAdventQuestStageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MAdventQuestStageCriteria that = (MAdventQuestStageCriteria) o;
        return
    ...
    public String toString() {
        return "MAdventQuestStageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
