...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MAdventQuestStageReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MAdventQuestStageRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-advent-quest-stage-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MAdventQuestStageRewardCriteria implements Serializable, Criteria {
    ...
    public MAdventQuestStageRewardCriteria(){
    }

    public MAdventQuestStageRewardCriteria(MAdventQuestStageRewardCriteria other){
    ...
    @Override
    public MAdventQuestStageRewardCriteria copy() {
        return new MAdventQuestStageRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MAdventQuestStageRewardCriteria that = (MAdventQuestStageRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MAdventQuestStageRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
