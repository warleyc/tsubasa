...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MAdventQuestStageReward} entity.
 */
public class MAdventQuestStageRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MAdventQuestStageRewardDTO mAdventQuestStageRewardDTO = (MAdventQuestStageRewardDTO) o;
        if (mAdventQuestStageRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mAdventQuestStageRewardDTO.getId());
    }
    ...
    public String toString() {
        return "MAdventQuestStageRewardDTO{" +
            "id=" + getId() +
            ", stageId=" + getStageId() +
            ", exp=" + getExp() +
            ", coin=" + getCoin() +
