...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MAdventQuestTsubasaPointReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MAdventQuestTsubasaPointRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-advent-quest-tsubasa-point-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MAdventQuestTsubasaPointRewardCriteria implements Serializable, Criteria {
    ...
    public MAdventQuestTsubasaPointRewardCriteria(){
    }

    public MAdventQuestTsubasaPointRewardCriteria(MAdventQuestTsubasaPointRewardCriteria other){
    ...
    @Override
    public MAdventQuestTsubasaPointRewardCriteria copy() {
        return new MAdventQuestTsubasaPointRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MAdventQuestTsubasaPointRewardCriteria that = (MAdventQuestTsubasaPointRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MAdventQuestTsubasaPointRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
