...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MAdventQuestWorld} entity.
 */
public class MAdventQuestWorldDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MAdventQuestWorldDTO mAdventQuestWorldDTO = (MAdventQuestWorldDTO) o;
        if (mAdventQuestWorldDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mAdventQuestWorldDTO.getId());
    }
