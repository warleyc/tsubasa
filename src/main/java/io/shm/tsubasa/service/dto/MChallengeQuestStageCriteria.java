...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MChallengeQuestStage} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MChallengeQuestStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-challenge-quest-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MChallengeQuestStageCriteria implements Serializable, Criteria {
    ...
    private IntegerFilter skipCheckPoint;
    ...
    public MChallengeQuestStageCriteria(MChallengeQuestStageCriteria other){
    ...
    @Override
    public MChallengeQuestStageCriteria copy() {
        return new MChallengeQuestStageCriteria(this);
    }
    ...
    public IntegerFilter getSkipCheckPoint() {
        return skipCheckPoint;
    }

    public void setSkipCheckPoint(IntegerFilter skipCheckPoint) {
        this.skipCheckPoint = skipCheckPoint;
    }

    public IntegerFilter getRoadNumber() {
        return roadNumber;
    }

    public void setRoadNumber(IntegerFilter roadNumber) {
    ...
    public boolean equals(Object o) {
        ...
        final MChallengeQuestStageCriteria that = (MChallengeQuestStageCriteria) o;
        return
    ...
    public String toString() {
        return "MChallengeQuestStageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
