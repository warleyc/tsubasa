...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MChallengeQuestStage} entity.
 */
public class MChallengeQuestStageDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MChallengeQuestStageDTO mChallengeQuestStageDTO = (MChallengeQuestStageDTO) o;
        if (mChallengeQuestStageDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mChallengeQuestStageDTO.getId());
    }
    ...
    public String toString() {
        return "MChallengeQuestStageDTO{" +
            "id=" + getId() +
            ", worldId=" + getWorldId() +
            ", number=" + getNumber() +
            ", name='" + getName() + "'" +
