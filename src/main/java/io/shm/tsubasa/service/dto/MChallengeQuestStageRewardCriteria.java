...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MChallengeQuestStageReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MChallengeQuestStageRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-challenge-quest-stage-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MChallengeQuestStageRewardCriteria implements Serializable, Criteria {
    ...
    public MChallengeQuestStageRewardCriteria(){
    }

    public MChallengeQuestStageRewardCriteria(MChallengeQuestStageRewardCriteria other){
    ...
    @Override
    public MChallengeQuestStageRewardCriteria copy() {
        return new MChallengeQuestStageRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MChallengeQuestStageRewardCriteria that = (MChallengeQuestStageRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MChallengeQuestStageRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
