...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MChallengeQuestWorld} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MChallengeQuestWorldResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-challenge-quest-worlds?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MChallengeQuestWorldCriteria implements Serializable, Criteria {
    ...
    private LongFilter mChallengeQuestStageId;

    public MChallengeQuestWorldCriteria(){
    }

    public MChallengeQuestWorldCriteria(MChallengeQuestWorldCriteria other){
        ...
        this.mChallengeQuestStageId = other.mChallengeQuestStageId == null ? null : other.mChallengeQuestStageId.copy();
    }

    @Override
    public MChallengeQuestWorldCriteria copy() {
        return new MChallengeQuestWorldCriteria(this);
    }
    ...
    public LongFilter getMChallengeQuestStageId() {
        return mChallengeQuestStageId;
    }

    public void setMChallengeQuestStageId(LongFilter mChallengeQuestStageId) {
        this.mChallengeQuestStageId = mChallengeQuestStageId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final MChallengeQuestWorldCriteria that = (MChallengeQuestWorldCriteria) o;
        return
            ...
            Objects.equals(mChallengeQuestStageId, that.mChallengeQuestStageId);
    }
    ...
    public int hashCode() {
        ...
        isEnableCoop,
        mChallengeQuestStageId
        );
    }

    @Override
    public String toString() {
        return "MChallengeQuestWorldCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                ...
                (mChallengeQuestStageId != null ? "mChallengeQuestStageId=" + mChallengeQuestStageId + ", " : "") +
            "}";
    }
