...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MChallengeQuestWorld} entity.
 */
public class MChallengeQuestWorldDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MChallengeQuestWorldDTO mChallengeQuestWorldDTO = (MChallengeQuestWorldDTO) o;
        if (mChallengeQuestWorldDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mChallengeQuestWorldDTO.getId());
    }
    ...
    public String toString() {
        return "MChallengeQuestWorldDTO{" +
            "id=" + getId() +
            ", setId=" + getSetId() +
            ", number=" + getNumber() +
            ", name='" + getName() + "'" +
