...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MCommonBanner} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MCommonBannerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-common-banners?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MCommonBannerCriteria implements Serializable, Criteria {
    ...
    public MCommonBannerCriteria(){
    }

    public MCommonBannerCriteria(MCommonBannerCriteria other){
    ...
    @Override
    public MCommonBannerCriteria copy() {
        return new MCommonBannerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MCommonBannerCriteria that = (MCommonBannerCriteria) o;
        return
