...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MGachaRenditionBeforeShootCutInPattern} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MGachaRenditionBeforeShootCutInPatternResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-gacha-rendition-before-shoot-cut-in-patterns?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MGachaRenditionBeforeShootCutInPatternCriteria implements Serializable, Criteria {
    ...
    public MGachaRenditionBeforeShootCutInPatternCriteria(){
    }

    public MGachaRenditionBeforeShootCutInPatternCriteria(MGachaRenditionBeforeShootCutInPatternCriteria other){
    ...
    @Override
    public MGachaRenditionBeforeShootCutInPatternCriteria copy() {
        return new MGachaRenditionBeforeShootCutInPatternCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MGachaRenditionBeforeShootCutInPatternCriteria that = (MGachaRenditionBeforeShootCutInPatternCriteria) o;
        return
    ...
    public String toString() {
        return "MGachaRenditionBeforeShootCutInPatternCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
