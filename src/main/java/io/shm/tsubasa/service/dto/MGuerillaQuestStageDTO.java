...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MGuerillaQuestStage} entity.
 */
public class MGuerillaQuestStageDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MGuerillaQuestStageDTO mGuerillaQuestStageDTO = (MGuerillaQuestStageDTO) o;
        if (mGuerillaQuestStageDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mGuerillaQuestStageDTO.getId());
    }
