...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MGuerillaQuestStageReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MGuerillaQuestStageRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-guerilla-quest-stage-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MGuerillaQuestStageRewardCriteria implements Serializable, Criteria {
    ...
    public MGuerillaQuestStageRewardCriteria(){
    }

    public MGuerillaQuestStageRewardCriteria(MGuerillaQuestStageRewardCriteria other){
    ...
    @Override
    public MGuerillaQuestStageRewardCriteria copy() {
        return new MGuerillaQuestStageRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MGuerillaQuestStageRewardCriteria that = (MGuerillaQuestStageRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MGuerillaQuestStageRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
