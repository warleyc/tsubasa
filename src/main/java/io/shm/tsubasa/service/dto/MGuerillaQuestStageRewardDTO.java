...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MGuerillaQuestStageReward} entity.
 */
public class MGuerillaQuestStageRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MGuerillaQuestStageRewardDTO mGuerillaQuestStageRewardDTO = (MGuerillaQuestStageRewardDTO) o;
        if (mGuerillaQuestStageRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mGuerillaQuestStageRewardDTO.getId());
    }
    ...
    public String toString() {
        return "MGuerillaQuestStageRewardDTO{" +
            "id=" + getId() +
            ", stageId=" + getStageId() +
            ", exp=" + getExp() +
            ", coin=" + getCoin() +
