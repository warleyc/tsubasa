...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MGuerillaQuestTsubasaPointReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MGuerillaQuestTsubasaPointRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-guerilla-quest-tsubasa-point-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MGuerillaQuestTsubasaPointRewardCriteria implements Serializable, Criteria {
    ...
    public MGuerillaQuestTsubasaPointRewardCriteria(){
    }

    public MGuerillaQuestTsubasaPointRewardCriteria(MGuerillaQuestTsubasaPointRewardCriteria other){
    ...
    @Override
    public MGuerillaQuestTsubasaPointRewardCriteria copy() {
        return new MGuerillaQuestTsubasaPointRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MGuerillaQuestTsubasaPointRewardCriteria that = (MGuerillaQuestTsubasaPointRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MGuerillaQuestTsubasaPointRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
