...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MGuerillaQuestWorld} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MGuerillaQuestWorldResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-guerilla-quest-worlds?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MGuerillaQuestWorldCriteria implements Serializable, Criteria {
    ...
    private LongFilter mGuerillaQuestStageId;

    public MGuerillaQuestWorldCriteria(){
    }

    public MGuerillaQuestWorldCriteria(MGuerillaQuestWorldCriteria other){
        ...
        this.mGuerillaQuestStageId = other.mGuerillaQuestStageId == null ? null : other.mGuerillaQuestStageId.copy();
    }

    @Override
    public MGuerillaQuestWorldCriteria copy() {
        return new MGuerillaQuestWorldCriteria(this);
    }
    ...
    public LongFilter getMGuerillaQuestStageId() {
        return mGuerillaQuestStageId;
    }

    public void setMGuerillaQuestStageId(LongFilter mGuerillaQuestStageId) {
        this.mGuerillaQuestStageId = mGuerillaQuestStageId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final MGuerillaQuestWorldCriteria that = (MGuerillaQuestWorldCriteria) o;
        return
            ...
            Objects.equals(mGuerillaQuestStageId, that.mGuerillaQuestStageId);
    }
    ...
    public int hashCode() {
        ...
        isEnableCoop,
        mGuerillaQuestStageId
        );
    }

    @Override
    public String toString() {
        return "MGuerillaQuestWorldCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                ...
                (mGuerillaQuestStageId != null ? "mGuerillaQuestStageId=" + mGuerillaQuestStageId + ", " : "") +
            "}";
    }
