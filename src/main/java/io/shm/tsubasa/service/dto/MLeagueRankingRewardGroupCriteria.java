...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MLeagueRankingRewardGroup} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MLeagueRankingRewardGroupResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-league-ranking-reward-groups?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MLeagueRankingRewardGroupCriteria implements Serializable, Criteria {
    ...
    public MLeagueRankingRewardGroupCriteria(){
    }

    public MLeagueRankingRewardGroupCriteria(MLeagueRankingRewardGroupCriteria other){
    ...
    @Override
    public MLeagueRankingRewardGroupCriteria copy() {
        return new MLeagueRankingRewardGroupCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MLeagueRankingRewardGroupCriteria that = (MLeagueRankingRewardGroupCriteria) o;
        return
    ...
    public String toString() {
        return "MLeagueRankingRewardGroupCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
