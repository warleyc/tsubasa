...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MLeagueRegulation} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MLeagueRegulationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-league-regulations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MLeagueRegulationCriteria implements Serializable, Criteria {
    ...
    public MLeagueRegulationCriteria(){
    }

    public MLeagueRegulationCriteria(MLeagueRegulationCriteria other){
    ...
    @Override
    public MLeagueRegulationCriteria copy() {
        return new MLeagueRegulationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MLeagueRegulationCriteria that = (MLeagueRegulationCriteria) o;
        return
    ...
    public String toString() {
        return "MLeagueRegulationCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
