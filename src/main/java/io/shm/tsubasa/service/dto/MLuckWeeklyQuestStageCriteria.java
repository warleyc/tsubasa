...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MLuckWeeklyQuestStage} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MLuckWeeklyQuestStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-luck-weekly-quest-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MLuckWeeklyQuestStageCriteria implements Serializable, Criteria {
    ...
    public MLuckWeeklyQuestStageCriteria(MLuckWeeklyQuestStageCriteria other){
    ...
    @Override
    public MLuckWeeklyQuestStageCriteria copy() {
        return new MLuckWeeklyQuestStageCriteria(this);
    }
    ...
    public IntegerFilter getLuckId() {
        return luckId;
    }

    public void setLuckId(IntegerFilter luckId) {
        this.luckId = luckId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final MLuckWeeklyQuestStageCriteria that = (MLuckWeeklyQuestStageCriteria) o;
        return
    ...
    public String toString() {
        return "MLuckWeeklyQuestStageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
