...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MLuckWeeklyQuestStage} entity.
 */
public class MLuckWeeklyQuestStageDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MLuckWeeklyQuestStageDTO mLuckWeeklyQuestStageDTO = (MLuckWeeklyQuestStageDTO) o;
        if (mLuckWeeklyQuestStageDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mLuckWeeklyQuestStageDTO.getId());
    }
    ...
    public String toString() {
        return "MLuckWeeklyQuestStageDTO{" +
            "id=" + getId() +
            ", worldId=" + getWorldId() +
            ", number=" + getNumber() +
            ", name='" + getName() + "'" +
