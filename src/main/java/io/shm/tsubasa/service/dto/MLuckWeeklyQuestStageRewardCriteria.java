...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MLuckWeeklyQuestStageReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MLuckWeeklyQuestStageRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-luck-weekly-quest-stage-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MLuckWeeklyQuestStageRewardCriteria implements Serializable, Criteria {
    ...
    public MLuckWeeklyQuestStageRewardCriteria(){
    }

    public MLuckWeeklyQuestStageRewardCriteria(MLuckWeeklyQuestStageRewardCriteria other){
    ...
    @Override
    public MLuckWeeklyQuestStageRewardCriteria copy() {
        return new MLuckWeeklyQuestStageRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MLuckWeeklyQuestStageRewardCriteria that = (MLuckWeeklyQuestStageRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MLuckWeeklyQuestStageRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
