...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MLuckWeeklyQuestStageReward} entity.
 */
public class MLuckWeeklyQuestStageRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MLuckWeeklyQuestStageRewardDTO mLuckWeeklyQuestStageRewardDTO = (MLuckWeeklyQuestStageRewardDTO) o;
        if (mLuckWeeklyQuestStageRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mLuckWeeklyQuestStageRewardDTO.getId());
    }
    ...
    public String toString() {
        return "MLuckWeeklyQuestStageRewardDTO{" +
            "id=" + getId() +
            ", stageId=" + getStageId() +
            ", exp=" + getExp() +
            ", coin=" + getCoin() +
