...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MLuckWeeklyQuestWorld} entity.
 */
public class MLuckWeeklyQuestWorldDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MLuckWeeklyQuestWorldDTO mLuckWeeklyQuestWorldDTO = (MLuckWeeklyQuestWorldDTO) o;
        if (mLuckWeeklyQuestWorldDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mLuckWeeklyQuestWorldDTO.getId());
    }
    ...
    public String toString() {
        return "MLuckWeeklyQuestWorldDTO{" +
            "id=" + getId() +
            ", setId=" + getSetId() +
            ", number=" + getNumber() +
            ", name='" + getName() + "'" +
