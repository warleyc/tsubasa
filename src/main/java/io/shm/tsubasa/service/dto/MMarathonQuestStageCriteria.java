...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MMarathonQuestStage} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MMarathonQuestStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-marathon-quest-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MMarathonQuestStageCriteria implements Serializable, Criteria {
    ...
    private LongFilter mmarathonquestworldId;

    public MMarathonQuestStageCriteria(){
    }

    public MMarathonQuestStageCriteria(MMarathonQuestStageCriteria other){
        ...
        this.mmarathonquestworldId = other.mmarathonquestworldId == null ? null : other.mmarathonquestworldId.copy();
    }

    @Override
    public MMarathonQuestStageCriteria copy() {
        return new MMarathonQuestStageCriteria(this);
    }
    ...
    public LongFilter getMmarathonquestworldId() {
        return mmarathonquestworldId;
    }

    public void setMmarathonquestworldId(LongFilter mmarathonquestworldId) {
    ...
    public boolean equals(Object o) {
        ...
        final MMarathonQuestStageCriteria that = (MMarathonQuestStageCriteria) o;
        return
            ...
            Objects.equals(mmarathonquestworldId, that.mmarathonquestworldId);
    }
    ...
    public int hashCode() {
        ...
        optionId,
        deckConditionId,
        mmarathonquestworldId
        );
    }

    @Override
    public String toString() {
        return "MMarathonQuestStageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                ...
                (mmarathonquestworldId != null ? "mmarathonquestworldId=" + mmarathonquestworldId + ", " : "") +
            "}";
    }
