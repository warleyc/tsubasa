...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MMarathonQuestStage} entity.
 */
public class MMarathonQuestStageDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MMarathonQuestStageDTO mMarathonQuestStageDTO = (MMarathonQuestStageDTO) o;
        if (mMarathonQuestStageDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mMarathonQuestStageDTO.getId());
    }
