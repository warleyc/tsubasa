...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MMarathonQuestStageReward} entity.
 */
public class MMarathonQuestStageRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MMarathonQuestStageRewardDTO mMarathonQuestStageRewardDTO = (MMarathonQuestStageRewardDTO) o;
        if (mMarathonQuestStageRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mMarathonQuestStageRewardDTO.getId());
    }
    ...
    public String toString() {
        return "MMarathonQuestStageRewardDTO{" +
            "id=" + getId() +
            ", stageId=" + getStageId() +
            ", exp=" + getExp() +
            ", coin=" + getCoin() +
