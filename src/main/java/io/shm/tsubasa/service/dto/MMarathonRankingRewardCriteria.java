...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MMarathonRankingReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MMarathonRankingRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-marathon-ranking-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MMarathonRankingRewardCriteria implements Serializable, Criteria {
    ...
    public MMarathonRankingRewardCriteria(){
    }

    public MMarathonRankingRewardCriteria(MMarathonRankingRewardCriteria other){
    ...
    @Override
    public MMarathonRankingRewardCriteria copy() {
        return new MMarathonRankingRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MMarathonRankingRewardCriteria that = (MMarathonRankingRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MMarathonRankingRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
