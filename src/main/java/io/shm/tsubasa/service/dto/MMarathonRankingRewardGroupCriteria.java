...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MMarathonRankingRewardGroup} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MMarathonRankingRewardGroupResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-marathon-ranking-reward-groups?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MMarathonRankingRewardGroupCriteria implements Serializable, Criteria {
    ...
    public MMarathonRankingRewardGroupCriteria(){
    }

    public MMarathonRankingRewardGroupCriteria(MMarathonRankingRewardGroupCriteria other){
    ...
    @Override
    public MMarathonRankingRewardGroupCriteria copy() {
        return new MMarathonRankingRewardGroupCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MMarathonRankingRewardGroupCriteria that = (MMarathonRankingRewardGroupCriteria) o;
        return
    ...
    public String toString() {
        return "MMarathonRankingRewardGroupCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
