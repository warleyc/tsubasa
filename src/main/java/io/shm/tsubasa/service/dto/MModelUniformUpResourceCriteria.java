...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MModelUniformUpResource} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MModelUniformUpResourceResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-model-uniform-up-resources?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MModelUniformUpResourceCriteria implements Serializable, Criteria {
    ...
    public MModelUniformUpResourceCriteria(){
    }

    public MModelUniformUpResourceCriteria(MModelUniformUpResourceCriteria other){
    ...
    @Override
    public MModelUniformUpResourceCriteria copy() {
        return new MModelUniformUpResourceCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MModelUniformUpResourceCriteria that = (MModelUniformUpResourceCriteria) o;
        return
    ...
    public String toString() {
        return "MModelUniformUpResourceCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
