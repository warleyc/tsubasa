...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MPvpRankingRewardGroup} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MPvpRankingRewardGroupResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-pvp-ranking-reward-groups?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MPvpRankingRewardGroupCriteria implements Serializable, Criteria {
    ...
    public MPvpRankingRewardGroupCriteria(){
    }

    public MPvpRankingRewardGroupCriteria(MPvpRankingRewardGroupCriteria other){
    ...
    @Override
    public MPvpRankingRewardGroupCriteria copy() {
        return new MPvpRankingRewardGroupCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MPvpRankingRewardGroupCriteria that = (MPvpRankingRewardGroupCriteria) o;
        return
    ...
    public String toString() {
        return "MPvpRankingRewardGroupCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
