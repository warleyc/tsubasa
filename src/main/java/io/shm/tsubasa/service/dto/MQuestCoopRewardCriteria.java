...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MQuestCoopReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MQuestCoopRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-quest-coop-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MQuestCoopRewardCriteria implements Serializable, Criteria {
    ...
    public MQuestCoopRewardCriteria(){
    }

    public MQuestCoopRewardCriteria(MQuestCoopRewardCriteria other){
    ...
    @Override
    public MQuestCoopRewardCriteria copy() {
        return new MQuestCoopRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MQuestCoopRewardCriteria that = (MQuestCoopRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MQuestCoopRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
