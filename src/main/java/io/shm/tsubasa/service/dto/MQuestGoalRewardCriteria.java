...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MQuestGoalReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MQuestGoalRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-quest-goal-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MQuestGoalRewardCriteria implements Serializable, Criteria {
    ...
    public MQuestGoalRewardCriteria(){
    }

    public MQuestGoalRewardCriteria(MQuestGoalRewardCriteria other){
    ...
    @Override
    public MQuestGoalRewardCriteria copy() {
        return new MQuestGoalRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MQuestGoalRewardCriteria that = (MQuestGoalRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MQuestGoalRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
