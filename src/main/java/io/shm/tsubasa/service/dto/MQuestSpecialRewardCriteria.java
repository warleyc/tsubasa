...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MQuestSpecialReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MQuestSpecialRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-quest-special-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MQuestSpecialRewardCriteria implements Serializable, Criteria {
    ...
    public MQuestSpecialRewardCriteria(){
    }

    public MQuestSpecialRewardCriteria(MQuestSpecialRewardCriteria other){
    ...
    @Override
    public MQuestSpecialRewardCriteria copy() {
        return new MQuestSpecialRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MQuestSpecialRewardCriteria that = (MQuestSpecialRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MQuestSpecialRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
