...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MQuestStage} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MQuestStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-quest-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MQuestStageCriteria implements Serializable, Criteria {
    ...
    public MQuestStageCriteria(MQuestStageCriteria other){
    ...
    @Override
    public MQuestStageCriteria copy() {
        return new MQuestStageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MQuestStageCriteria that = (MQuestStageCriteria) o;
        return
