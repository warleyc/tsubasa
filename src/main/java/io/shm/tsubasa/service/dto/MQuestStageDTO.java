...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MQuestStage} entity.
 */
public class MQuestStageDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MQuestStageDTO mQuestStageDTO = (MQuestStageDTO) o;
        if (mQuestStageDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mQuestStageDTO.getId());
    }
