...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MQuestStageReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MQuestStageRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-quest-stage-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MQuestStageRewardCriteria implements Serializable, Criteria {
    ...
    public MQuestStageRewardCriteria(){
    }

    public MQuestStageRewardCriteria(MQuestStageRewardCriteria other){
    ...
    @Override
    public MQuestStageRewardCriteria copy() {
        return new MQuestStageRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MQuestStageRewardCriteria that = (MQuestStageRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MQuestStageRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
