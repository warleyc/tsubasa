...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MQuestStageReward} entity.
 */
public class MQuestStageRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MQuestStageRewardDTO mQuestStageRewardDTO = (MQuestStageRewardDTO) o;
        if (mQuestStageRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mQuestStageRewardDTO.getId());
    }
