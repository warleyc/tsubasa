...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MQuestTsubasaPointReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MQuestTsubasaPointRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-quest-tsubasa-point-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MQuestTsubasaPointRewardCriteria implements Serializable, Criteria {
    ...
    public MQuestTsubasaPointRewardCriteria(){
    }

    public MQuestTsubasaPointRewardCriteria(MQuestTsubasaPointRewardCriteria other){
    ...
    @Override
    public MQuestTsubasaPointRewardCriteria copy() {
        return new MQuestTsubasaPointRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MQuestTsubasaPointRewardCriteria that = (MQuestTsubasaPointRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MQuestTsubasaPointRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
