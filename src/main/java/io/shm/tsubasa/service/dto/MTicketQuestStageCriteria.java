...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MTicketQuestStage} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MTicketQuestStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-ticket-quest-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MTicketQuestStageCriteria implements Serializable, Criteria {
    ...
    public MTicketQuestStageCriteria(MTicketQuestStageCriteria other){
    ...
    @Override
    public MTicketQuestStageCriteria copy() {
        return new MTicketQuestStageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MTicketQuestStageCriteria that = (MTicketQuestStageCriteria) o;
        return
    ...
    public String toString() {
        return "MTicketQuestStageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
