...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MTicketQuestStage} entity.
 */
public class MTicketQuestStageDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MTicketQuestStageDTO mTicketQuestStageDTO = (MTicketQuestStageDTO) o;
        if (mTicketQuestStageDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mTicketQuestStageDTO.getId());
    }
