...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MTicketQuestStageReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MTicketQuestStageRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-ticket-quest-stage-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MTicketQuestStageRewardCriteria implements Serializable, Criteria {
    ...
    public MTicketQuestStageRewardCriteria(){
    }

    public MTicketQuestStageRewardCriteria(MTicketQuestStageRewardCriteria other){
    ...
    @Override
    public MTicketQuestStageRewardCriteria copy() {
        return new MTicketQuestStageRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MTicketQuestStageRewardCriteria that = (MTicketQuestStageRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MTicketQuestStageRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
