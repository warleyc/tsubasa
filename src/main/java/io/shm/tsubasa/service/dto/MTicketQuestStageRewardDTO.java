...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MTicketQuestStageReward} entity.
 */
public class MTicketQuestStageRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MTicketQuestStageRewardDTO mTicketQuestStageRewardDTO = (MTicketQuestStageRewardDTO) o;
        if (mTicketQuestStageRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mTicketQuestStageRewardDTO.getId());
    }
    ...
    public String toString() {
        return "MTicketQuestStageRewardDTO{" +
            "id=" + getId() +
            ", stageId=" + getStageId() +
            ", exp=" + getExp() +
            ", coin=" + getCoin() +
