...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MTicketQuestTsubasaPointReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MTicketQuestTsubasaPointRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-ticket-quest-tsubasa-point-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MTicketQuestTsubasaPointRewardCriteria implements Serializable, Criteria {
    ...
    public MTicketQuestTsubasaPointRewardCriteria(){
    }

    public MTicketQuestTsubasaPointRewardCriteria(MTicketQuestTsubasaPointRewardCriteria other){
    ...
    @Override
    public MTicketQuestTsubasaPointRewardCriteria copy() {
        return new MTicketQuestTsubasaPointRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MTicketQuestTsubasaPointRewardCriteria that = (MTicketQuestTsubasaPointRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MTicketQuestTsubasaPointRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
