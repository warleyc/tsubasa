...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MTimeattackQuestStage} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MTimeattackQuestStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-timeattack-quest-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MTimeattackQuestStageCriteria implements Serializable, Criteria {
    ...
    private IntegerFilter ticketId;

    private IntegerFilter ticketAmount;
    ...
    private LongFilter mtimeattackquestworldId;

    public MTimeattackQuestStageCriteria(){
    }

    public MTimeattackQuestStageCriteria(MTimeattackQuestStageCriteria other){
        ...
        this.ticketAmount = other.ticketAmount == null ? null : other.ticketAmount.copy();
        ...
        this.mtimeattackquestworldId = other.mtimeattackquestworldId == null ? null : other.mtimeattackquestworldId.copy();
    }

    @Override
    public MTimeattackQuestStageCriteria copy() {
        return new MTimeattackQuestStageCriteria(this);
    }
    ...
    public IntegerFilter getTicketId() {
        return ticketId;
    }

    public void setTicketId(IntegerFilter ticketId) {
        this.ticketId = ticketId;
    }

    public IntegerFilter getTicketAmount() {
        return ticketAmount;
    }

    public void setTicketAmount(IntegerFilter ticketAmount) {
    ...
    public LongFilter getMtimeattackquestworldId() {
        return mtimeattackquestworldId;
    }

    public void setMtimeattackquestworldId(LongFilter mtimeattackquestworldId) {
    ...
    public boolean equals(Object o) {
        ...
        final MTimeattackQuestStageCriteria that = (MTimeattackQuestStageCriteria) o;
        return
            ...
            Objects.equals(mtimeattackquestworldId, that.mtimeattackquestworldId);
    }
    ...
    public int hashCode() {
        ...
        optionId,
        deckConditionId,
        mtimeattackquestworldId
        );
    }

    @Override
    public String toString() {
        return "MTimeattackQuestStageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                ...
                (ticketAmount != null ? "ticketAmount=" + ticketAmount + ", " : "") +
                ...
                (mtimeattackquestworldId != null ? "mtimeattackquestworldId=" + mtimeattackquestworldId + ", " : "") +
            "}";
    }
