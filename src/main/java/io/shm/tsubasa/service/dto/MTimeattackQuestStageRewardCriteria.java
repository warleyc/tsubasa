...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MTimeattackQuestStageReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MTimeattackQuestStageRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-timeattack-quest-stage-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MTimeattackQuestStageRewardCriteria implements Serializable, Criteria {
    ...
    public MTimeattackQuestStageRewardCriteria(){
    }

    public MTimeattackQuestStageRewardCriteria(MTimeattackQuestStageRewardCriteria other){
    ...
    @Override
    public MTimeattackQuestStageRewardCriteria copy() {
        return new MTimeattackQuestStageRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MTimeattackQuestStageRewardCriteria that = (MTimeattackQuestStageRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MTimeattackQuestStageRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
