...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MTimeattackQuestStageReward} entity.
 */
public class MTimeattackQuestStageRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MTimeattackQuestStageRewardDTO mTimeattackQuestStageRewardDTO = (MTimeattackQuestStageRewardDTO) o;
        if (mTimeattackQuestStageRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mTimeattackQuestStageRewardDTO.getId());
    }
    ...
    public String toString() {
        return "MTimeattackQuestStageRewardDTO{" +
            "id=" + getId() +
            ", stageId=" + getStageId() +
            ", exp=" + getExp() +
            ", coin=" + getCoin() +
