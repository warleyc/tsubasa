...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MTimeattackQuestWorld} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MTimeattackQuestWorldResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-timeattack-quest-worlds?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MTimeattackQuestWorldCriteria implements Serializable, Criteria {
    ...
    private LongFilter mTimeattackQuestStageId;

    public MTimeattackQuestWorldCriteria(){
    }

    public MTimeattackQuestWorldCriteria(MTimeattackQuestWorldCriteria other){
        ...
        this.mTimeattackQuestStageId = other.mTimeattackQuestStageId == null ? null : other.mTimeattackQuestStageId.copy();
    }

    @Override
    public MTimeattackQuestWorldCriteria copy() {
        return new MTimeattackQuestWorldCriteria(this);
    }
    ...
    public LongFilter getMTimeattackQuestStageId() {
        return mTimeattackQuestStageId;
    }

    public void setMTimeattackQuestStageId(LongFilter mTimeattackQuestStageId) {
        this.mTimeattackQuestStageId = mTimeattackQuestStageId;
    }
    ...
    public boolean equals(Object o) {
        ...
        final MTimeattackQuestWorldCriteria that = (MTimeattackQuestWorldCriteria) o;
        return
            ...
            Objects.equals(mTimeattackQuestStageId, that.mTimeattackQuestStageId);
    }
    ...
    public int hashCode() {
        ...
        isEnableCoop,
        mTimeattackQuestStageId
        );
    }

    @Override
    public String toString() {
        return "MTimeattackQuestWorldCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                ...
                (mTimeattackQuestStageId != null ? "mTimeattackQuestStageId=" + mTimeattackQuestStageId + ", " : "") +
            "}";
    }
