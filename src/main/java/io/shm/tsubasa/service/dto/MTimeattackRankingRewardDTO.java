...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MTimeattackRankingReward} entity.
 */
public class MTimeattackRankingRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MTimeattackRankingRewardDTO mTimeattackRankingRewardDTO = (MTimeattackRankingRewardDTO) o;
        if (mTimeattackRankingRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mTimeattackRankingRewardDTO.getId());
    }
    ...
    public String toString() {
        return "MTimeattackRankingRewardDTO{" +
            "id=" + getId() +
            ", eventId=" + getEventId() +
