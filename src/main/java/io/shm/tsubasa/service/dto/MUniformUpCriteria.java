...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MUniformUp} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MUniformUpResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-uniform-ups?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MUniformUpCriteria implements Serializable, Criteria {
    ...
    public MUniformUpCriteria(){
    }

    public MUniformUpCriteria(MUniformUpCriteria other){
    ...
    @Override
    public MUniformUpCriteria copy() {
        return new MUniformUpCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MUniformUpCriteria that = (MUniformUpCriteria) o;
        return
