...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MUniformUp} entity.
 */
public class MUniformUpDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MUniformUpDTO mUniformUpDTO = (MUniformUpDTO) o;
        if (mUniformUpDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mUniformUpDTO.getId());
    }
