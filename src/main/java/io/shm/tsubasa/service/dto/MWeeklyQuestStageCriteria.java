...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MWeeklyQuestStage} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MWeeklyQuestStageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-weekly-quest-stages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MWeeklyQuestStageCriteria implements Serializable, Criteria {
    ...
    public MWeeklyQuestStageCriteria(MWeeklyQuestStageCriteria other){
    ...
    @Override
    public MWeeklyQuestStageCriteria copy() {
        return new MWeeklyQuestStageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MWeeklyQuestStageCriteria that = (MWeeklyQuestStageCriteria) o;
        return
    ...
    public String toString() {
        return "MWeeklyQuestStageCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
