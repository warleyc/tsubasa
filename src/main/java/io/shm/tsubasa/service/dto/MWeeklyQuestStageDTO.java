...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MWeeklyQuestStage} entity.
 */
public class MWeeklyQuestStageDTO implements Serializable {
    ...
    private Long mweeklyquestworldId;
    ...
    public Long getMweeklyquestworldId() {
        return mweeklyquestworldId;
    }

    public void setMweeklyquestworldId(Long mWeeklyQuestWorldId) {
    ...
    public boolean equals(Object o) {
        ...
        MWeeklyQuestStageDTO mWeeklyQuestStageDTO = (MWeeklyQuestStageDTO) o;
        if (mWeeklyQuestStageDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mWeeklyQuestStageDTO.getId());
    }
    ...
    public String toString() {
        return "MWeeklyQuestStageDTO{" +
            ...
            ", mweeklyquestworld=" + getMweeklyquestworldId() +
            "}";
    }
}
