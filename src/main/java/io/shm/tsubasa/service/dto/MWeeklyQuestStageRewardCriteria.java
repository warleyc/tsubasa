...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MWeeklyQuestStageReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MWeeklyQuestStageRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-weekly-quest-stage-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MWeeklyQuestStageRewardCriteria implements Serializable, Criteria {
    ...
    public MWeeklyQuestStageRewardCriteria(){
    }

    public MWeeklyQuestStageRewardCriteria(MWeeklyQuestStageRewardCriteria other){
    ...
    @Override
    public MWeeklyQuestStageRewardCriteria copy() {
        return new MWeeklyQuestStageRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MWeeklyQuestStageRewardCriteria that = (MWeeklyQuestStageRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MWeeklyQuestStageRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
