...
/**
 * A DTO for the {@link io.shm.tsubasa.domain.MWeeklyQuestStageReward} entity.
 */
public class MWeeklyQuestStageRewardDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MWeeklyQuestStageRewardDTO mWeeklyQuestStageRewardDTO = (MWeeklyQuestStageRewardDTO) o;
        if (mWeeklyQuestStageRewardDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mWeeklyQuestStageRewardDTO.getId());
    }
    ...
    public String toString() {
        return "MWeeklyQuestStageRewardDTO{" +
            "id=" + getId() +
            ", stageId=" + getStageId() +
            ", exp=" + getExp() +
            ", coin=" + getCoin() +
