...
/**
 * Criteria class for the {@link io.shm.tsubasa.domain.MWeeklyQuestTsubasaPointReward} entity. This class is used
 * in {@link io.shm.tsubasa.web.rest.MWeeklyQuestTsubasaPointRewardResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /m-weekly-quest-tsubasa-point-rewards?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class MWeeklyQuestTsubasaPointRewardCriteria implements Serializable, Criteria {
    ...
    public MWeeklyQuestTsubasaPointRewardCriteria(){
    }

    public MWeeklyQuestTsubasaPointRewardCriteria(MWeeklyQuestTsubasaPointRewardCriteria other){
    ...
    @Override
    public MWeeklyQuestTsubasaPointRewardCriteria copy() {
        return new MWeeklyQuestTsubasaPointRewardCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final MWeeklyQuestTsubasaPointRewardCriteria that = (MWeeklyQuestTsubasaPointRewardCriteria) o;
        return
    ...
    public String toString() {
        return "MWeeklyQuestTsubasaPointRewardCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
