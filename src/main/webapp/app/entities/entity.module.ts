...
@NgModule({
  imports: [
    RouterModule.forChild([
      ...
      {
        path: 'm-action-skill-holder-card-content',
        loadChildren:
          './m-action-skill-holder-card-content/m-action-skill-holder-card-content.module#TsubasaMActionSkillHolderCardContentModule'
      },
      {
        path: 'm-character',
        loadChildren: './m-character/m-character.module#TsubasaMCharacterModule'
      ...
      {
        path: 'm-team',
        loadChildren: './m-team/m-team.module#TsubasaMTeamModule'
      },
      {
        path: 'm-achievement',
        loadChildren: './m-achievement/m-achievement.module#TsubasaMAchievementModule'
