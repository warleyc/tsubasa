...
export class MAdventQuestStageUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    optionId: [],
    deckConditionId: [],
    madventquestworldId: [null, Validators.required]
  });
  ...
  updateForm(mAdventQuestStage: IMAdventQuestStage) {
    this.editForm.patchValue({
      ...
      madventquestworldId: mAdventQuestStage.madventquestworldId
    });
  }
  ...
  private createFromForm(): IMAdventQuestStage {
    const entity = {
      ...
      madventquestworldId: this.editForm.get(['madventquestworldId']).value
    };
    return entity;
  }
