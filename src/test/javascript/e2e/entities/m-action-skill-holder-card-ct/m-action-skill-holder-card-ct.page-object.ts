...
export class MActionSkillHolderCardCtComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-action-skill-holder-card-ct div table .btn-danger'));
  title = element.all(by.css('jhi-m-action-skill-holder-card-ct div h2#page-heading span')).first();
...
export class MActionSkillHolderCardCtUpdatePage {
  pageTitle = element(by.id('jhi-m-action-skill-holder-card-ct-heading'));
...
export class MActionSkillHolderCardCtDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mActionSkillHolderCardCt-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mActionSkillHolderCardCt'));
