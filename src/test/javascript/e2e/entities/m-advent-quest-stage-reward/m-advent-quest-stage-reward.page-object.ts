...
export class MAdventQuestStageRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-advent-quest-stage-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-advent-quest-stage-reward div h2#page-heading span')).first();
...
export class MAdventQuestStageRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-advent-quest-stage-reward-heading'));
...
export class MAdventQuestStageRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mAdventQuestStageReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mAdventQuestStageReward'));
