...
export class MAdventQuestStageComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-advent-quest-stage div table .btn-danger'));
  title = element.all(by.css('jhi-m-advent-quest-stage div h2#page-heading span')).first();
...
export class MAdventQuestStageUpdatePage {
  pageTitle = element(by.id('jhi-m-advent-quest-stage-heading'));
...
export class MAdventQuestStageDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mAdventQuestStage-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mAdventQuestStage'));
