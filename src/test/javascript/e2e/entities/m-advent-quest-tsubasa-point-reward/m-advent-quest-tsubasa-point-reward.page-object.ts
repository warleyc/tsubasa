...
export class MAdventQuestTsubasaPointRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-advent-quest-tsubasa-point-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-advent-quest-tsubasa-point-reward div h2#page-heading span')).first();
...
export class MAdventQuestTsubasaPointRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-advent-quest-tsubasa-point-reward-heading'));
...
export class MAdventQuestTsubasaPointRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mAdventQuestTsubasaPointReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mAdventQuestTsubasaPointReward'));
