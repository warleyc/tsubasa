...
export class MChallengeQuestAchievementRewardGroupComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-challenge-quest-achievement-reward-group div table .btn-danger'));
  title = element.all(by.css('jhi-m-challenge-quest-achievement-reward-group div h2#page-heading span')).first();
...
export class MChallengeQuestAchievementRewardGroupUpdatePage {
  pageTitle = element(by.id('jhi-m-challenge-quest-achievement-reward-group-heading'));
...
export class MChallengeQuestAchievementRewardGroupDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mChallengeQuestAchievementRewardGroup-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mChallengeQuestAchievementRewardGroup'));
