...
export class MChallengeQuestStageRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-challenge-quest-stage-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-challenge-quest-stage-reward div h2#page-heading span')).first();
...
export class MChallengeQuestStageRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-challenge-quest-stage-reward-heading'));
...
export class MChallengeQuestStageRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mChallengeQuestStageReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mChallengeQuestStageReward'));
