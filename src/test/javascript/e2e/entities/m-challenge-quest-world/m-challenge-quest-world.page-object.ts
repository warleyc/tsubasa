...
export class MChallengeQuestWorldComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-challenge-quest-world div table .btn-danger'));
  title = element.all(by.css('jhi-m-challenge-quest-world div h2#page-heading span')).first();
...
export class MChallengeQuestWorldUpdatePage {
  pageTitle = element(by.id('jhi-m-challenge-quest-world-heading'));
...
export class MChallengeQuestWorldDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mChallengeQuestWorld-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mChallengeQuestWorld'));
