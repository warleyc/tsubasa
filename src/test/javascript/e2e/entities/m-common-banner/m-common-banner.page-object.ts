...
export class MCommonBannerComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-common-banner div table .btn-danger'));
  title = element.all(by.css('jhi-m-common-banner div h2#page-heading span')).first();
...
export class MCommonBannerUpdatePage {
  pageTitle = element(by.id('jhi-m-common-banner-heading'));
...
export class MCommonBannerDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mCommonBanner-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mCommonBanner'));
