...
export class MGuerillaQuestStageRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-guerilla-quest-stage-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-guerilla-quest-stage-reward div h2#page-heading span')).first();
...
export class MGuerillaQuestStageRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-guerilla-quest-stage-reward-heading'));
...
export class MGuerillaQuestStageRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mGuerillaQuestStageReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mGuerillaQuestStageReward'));
