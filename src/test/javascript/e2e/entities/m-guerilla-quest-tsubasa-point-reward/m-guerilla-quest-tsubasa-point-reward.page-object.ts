...
export class MGuerillaQuestTsubasaPointRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-guerilla-quest-tsubasa-point-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-guerilla-quest-tsubasa-point-reward div h2#page-heading span')).first();
...
export class MGuerillaQuestTsubasaPointRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-guerilla-quest-tsubasa-point-reward-heading'));
...
export class MGuerillaQuestTsubasaPointRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mGuerillaQuestTsubasaPointReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mGuerillaQuestTsubasaPointReward'));
