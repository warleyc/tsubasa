...
export class MGuerillaQuestWorldComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-guerilla-quest-world div table .btn-danger'));
  title = element.all(by.css('jhi-m-guerilla-quest-world div h2#page-heading span')).first();
...
export class MGuerillaQuestWorldUpdatePage {
  pageTitle = element(by.id('jhi-m-guerilla-quest-world-heading'));
...
export class MGuerillaQuestWorldDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mGuerillaQuestWorld-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mGuerillaQuestWorld'));
