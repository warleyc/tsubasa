...
export class MLeagueRankingRewardGroupComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-league-ranking-reward-group div table .btn-danger'));
  title = element.all(by.css('jhi-m-league-ranking-reward-group div h2#page-heading span')).first();
...
export class MLeagueRankingRewardGroupUpdatePage {
  pageTitle = element(by.id('jhi-m-league-ranking-reward-group-heading'));
...
export class MLeagueRankingRewardGroupDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mLeagueRankingRewardGroup-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mLeagueRankingRewardGroup'));
