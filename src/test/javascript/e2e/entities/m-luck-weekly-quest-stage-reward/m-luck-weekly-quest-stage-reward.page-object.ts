...
export class MLuckWeeklyQuestStageRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-luck-weekly-quest-stage-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-luck-weekly-quest-stage-reward div h2#page-heading span')).first();
...
export class MLuckWeeklyQuestStageRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-luck-weekly-quest-stage-reward-heading'));
...
export class MLuckWeeklyQuestStageRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mLuckWeeklyQuestStageReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mLuckWeeklyQuestStageReward'));
