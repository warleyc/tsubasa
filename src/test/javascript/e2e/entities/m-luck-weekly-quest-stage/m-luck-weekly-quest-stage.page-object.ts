...
export class MLuckWeeklyQuestStageComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-luck-weekly-quest-stage div table .btn-danger'));
  title = element.all(by.css('jhi-m-luck-weekly-quest-stage div h2#page-heading span')).first();
...
export class MLuckWeeklyQuestStageUpdatePage {
  pageTitle = element(by.id('jhi-m-luck-weekly-quest-stage-heading'));
  ...
  async setLuckIdInput(luckId) {
    await this.luckIdInput.sendKeys(luckId);
  }

  async getLuckIdInput() {
...
export class MLuckWeeklyQuestStageDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mLuckWeeklyQuestStage-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mLuckWeeklyQuestStage'));
