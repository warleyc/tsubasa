...
export class MMarathonAchievementRewardGroupComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-marathon-achievement-reward-group div table .btn-danger'));
  title = element.all(by.css('jhi-m-marathon-achievement-reward-group div h2#page-heading span')).first();
...
export class MMarathonAchievementRewardGroupUpdatePage {
  pageTitle = element(by.id('jhi-m-marathon-achievement-reward-group-heading'));
...
export class MMarathonAchievementRewardGroupDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mMarathonAchievementRewardGroup-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mMarathonAchievementRewardGroup'));
