...
export class MMarathonQuestStageComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-marathon-quest-stage div table .btn-danger'));
  title = element.all(by.css('jhi-m-marathon-quest-stage div h2#page-heading span')).first();
...
export class MMarathonQuestStageUpdatePage {
  pageTitle = element(by.id('jhi-m-marathon-quest-stage-heading'));
...
export class MMarathonQuestStageDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mMarathonQuestStage-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mMarathonQuestStage'));
