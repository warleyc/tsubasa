...
export class MMarathonRankingRewardGroupComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-marathon-ranking-reward-group div table .btn-danger'));
  title = element.all(by.css('jhi-m-marathon-ranking-reward-group div h2#page-heading span')).first();
...
export class MMarathonRankingRewardGroupUpdatePage {
  pageTitle = element(by.id('jhi-m-marathon-ranking-reward-group-heading'));
...
export class MMarathonRankingRewardGroupDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mMarathonRankingRewardGroup-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mMarathonRankingRewardGroup'));
