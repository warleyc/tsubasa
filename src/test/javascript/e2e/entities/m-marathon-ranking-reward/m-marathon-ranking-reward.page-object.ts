...
export class MMarathonRankingRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-marathon-ranking-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-marathon-ranking-reward div h2#page-heading span')).first();
...
export class MMarathonRankingRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-marathon-ranking-reward-heading'));
...
export class MMarathonRankingRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mMarathonRankingReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mMarathonRankingReward'));
