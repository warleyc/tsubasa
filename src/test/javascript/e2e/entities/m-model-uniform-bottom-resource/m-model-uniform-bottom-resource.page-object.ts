...
export class MModelUniformBottomResourceComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-model-uniform-bottom-resource div table .btn-danger'));
  title = element.all(by.css('jhi-m-model-uniform-bottom-resource div h2#page-heading span')).first();
...
export class MModelUniformBottomResourceUpdatePage {
  pageTitle = element(by.id('jhi-m-model-uniform-bottom-resource-heading'));
...
export class MModelUniformBottomResourceDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mModelUniformBottomResource-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mModelUniformBottomResource'));
