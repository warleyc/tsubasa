...
export class MPvpRankingRewardGroupComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-pvp-ranking-reward-group div table .btn-danger'));
  title = element.all(by.css('jhi-m-pvp-ranking-reward-group div h2#page-heading span')).first();
...
export class MPvpRankingRewardGroupUpdatePage {
  pageTitle = element(by.id('jhi-m-pvp-ranking-reward-group-heading'));
...
export class MPvpRankingRewardGroupDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mPvpRankingRewardGroup-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mPvpRankingRewardGroup'));
