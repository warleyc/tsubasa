...
export class MQuestRewardGroupComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-quest-reward-group div table .btn-danger'));
  title = element.all(by.css('jhi-m-quest-reward-group div h2#page-heading span')).first();
...
export class MQuestRewardGroupUpdatePage {
  pageTitle = element(by.id('jhi-m-quest-reward-group-heading'));
...
export class MQuestRewardGroupDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mQuestRewardGroup-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mQuestRewardGroup'));
