...
export class MQuestSpecialRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-quest-special-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-quest-special-reward div h2#page-heading span')).first();
...
export class MQuestSpecialRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-quest-special-reward-heading'));
...
export class MQuestSpecialRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mQuestSpecialReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mQuestSpecialReward'));
