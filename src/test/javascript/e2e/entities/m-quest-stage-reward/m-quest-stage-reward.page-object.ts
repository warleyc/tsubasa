...
export class MQuestStageRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-quest-stage-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-quest-stage-reward div h2#page-heading span')).first();
...
export class MQuestStageRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-quest-stage-reward-heading'));
...
export class MQuestStageRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mQuestStageReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mQuestStageReward'));
