...
export class MQuestTsubasaPointRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-quest-tsubasa-point-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-quest-tsubasa-point-reward div h2#page-heading span')).first();
...
export class MQuestTsubasaPointRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-quest-tsubasa-point-reward-heading'));
...
export class MQuestTsubasaPointRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mQuestTsubasaPointReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mQuestTsubasaPointReward'));
