...
export class MTicketQuestStageRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-ticket-quest-stage-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-ticket-quest-stage-reward div h2#page-heading span')).first();
...
export class MTicketQuestStageRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-ticket-quest-stage-reward-heading'));
...
export class MTicketQuestStageRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mTicketQuestStageReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mTicketQuestStageReward'));
