...
export class MTicketQuestStageComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-ticket-quest-stage div table .btn-danger'));
  title = element.all(by.css('jhi-m-ticket-quest-stage div h2#page-heading span')).first();
...
export class MTicketQuestStageUpdatePage {
  pageTitle = element(by.id('jhi-m-ticket-quest-stage-heading'));
...
export class MTicketQuestStageDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mTicketQuestStage-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mTicketQuestStage'));
