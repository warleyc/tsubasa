...
export class MTicketQuestTsubasaPointRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-ticket-quest-tsubasa-point-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-ticket-quest-tsubasa-point-reward div h2#page-heading span')).first();
...
export class MTicketQuestTsubasaPointRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-ticket-quest-tsubasa-point-reward-heading'));
...
export class MTicketQuestTsubasaPointRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mTicketQuestTsubasaPointReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mTicketQuestTsubasaPointReward'));
