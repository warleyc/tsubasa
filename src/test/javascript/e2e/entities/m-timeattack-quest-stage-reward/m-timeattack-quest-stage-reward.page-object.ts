...
export class MTimeattackQuestStageRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-timeattack-quest-stage-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-timeattack-quest-stage-reward div h2#page-heading span')).first();
...
export class MTimeattackQuestStageRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-timeattack-quest-stage-reward-heading'));
...
export class MTimeattackQuestStageRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mTimeattackQuestStageReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mTimeattackQuestStageReward'));
