...
export class MTimeattackRankingRewardGroupComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-timeattack-ranking-reward-group div table .btn-danger'));
  title = element.all(by.css('jhi-m-timeattack-ranking-reward-group div h2#page-heading span')).first();
...
export class MTimeattackRankingRewardGroupUpdatePage {
  pageTitle = element(by.id('jhi-m-timeattack-ranking-reward-group-heading'));
...
export class MTimeattackRankingRewardGroupDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mTimeattackRankingRewardGroup-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mTimeattackRankingRewardGroup'));
