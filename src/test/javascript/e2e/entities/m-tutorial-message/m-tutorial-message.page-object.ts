...
export class MTutorialMessageComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-tutorial-message div table .btn-danger'));
  title = element.all(by.css('jhi-m-tutorial-message div h2#page-heading span')).first();
...
export class MTutorialMessageUpdatePage {
  pageTitle = element(by.id('jhi-m-tutorial-message-heading'));
...
export class MTutorialMessageDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mTutorialMessage-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mTutorialMessage'));
