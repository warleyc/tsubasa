...
export class MUniformUpComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-uniform-up div table .btn-danger'));
  title = element.all(by.css('jhi-m-uniform-up div h2#page-heading span')).first();
...
export class MUniformUpUpdatePage {
  pageTitle = element(by.id('jhi-m-uniform-up-heading'));
...
export class MUniformUpDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mUniformUp-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mUniformUp'));
