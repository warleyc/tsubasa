...
export class MWeeklyQuestStageRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-weekly-quest-stage-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-weekly-quest-stage-reward div h2#page-heading span')).first();
...
export class MWeeklyQuestStageRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-weekly-quest-stage-reward-heading'));
...
export class MWeeklyQuestStageRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mWeeklyQuestStageReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mWeeklyQuestStageReward'));
