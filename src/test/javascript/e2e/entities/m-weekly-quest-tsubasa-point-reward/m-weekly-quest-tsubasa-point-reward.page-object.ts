...
export class MWeeklyQuestTsubasaPointRewardComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-weekly-quest-tsubasa-point-reward div table .btn-danger'));
  title = element.all(by.css('jhi-m-weekly-quest-tsubasa-point-reward div h2#page-heading span')).first();
...
export class MWeeklyQuestTsubasaPointRewardUpdatePage {
  pageTitle = element(by.id('jhi-m-weekly-quest-tsubasa-point-reward-heading'));
...
export class MWeeklyQuestTsubasaPointRewardDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mWeeklyQuestTsubasaPointReward-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mWeeklyQuestTsubasaPointReward'));
