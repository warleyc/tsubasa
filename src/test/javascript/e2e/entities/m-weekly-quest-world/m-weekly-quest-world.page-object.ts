...
export class MWeeklyQuestWorldComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-m-weekly-quest-world div table .btn-danger'));
  title = element.all(by.css('jhi-m-weekly-quest-world div h2#page-heading span')).first();
...
export class MWeeklyQuestWorldUpdatePage {
  pageTitle = element(by.id('jhi-m-weekly-quest-world-heading'));
...
export class MWeeklyQuestWorldDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-mWeeklyQuestWorld-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-mWeeklyQuestWorld'));
