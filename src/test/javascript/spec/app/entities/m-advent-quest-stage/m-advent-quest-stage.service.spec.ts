...
describe('Service Tests', () => {
  describe('MAdventQuestStage Service', () => {
    let injector: TestBed;
    let service: MAdventQuestStageService;
    let httpMock: HttpTestingController;
    let elemDefault: IMAdventQuestStage;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(MAdventQuestStageService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new MAdventQuestStage(
        0,
        0,
        0,
        'AAAAAAA',
    ...
    describe('Service methods', () => {
      ...
      it('should create a MAdventQuestStage', async () => {
        ...
        service
          .create(new MAdventQuestStage(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a MAdventQuestStage', async () => {
        const returnedFromService = Object.assign(
          {
            worldId: 1,
            number: 1,
      ...
      it('should return a list of MAdventQuestStage', async () => {
        const returnedFromService = Object.assign(
          {
            worldId: 1,
            number: 1,
      ...
      it('should delete a MAdventQuestStage', async () => {
