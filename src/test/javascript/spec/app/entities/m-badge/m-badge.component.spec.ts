...
import { MBadgeComponent } from 'app/entities/m-badge/m-badge.component';
import { MBadgeService } from 'app/entities/m-badge/m-badge.service';
import { MBadge } from 'app/shared/model/m-badge.model';

describe('Component Tests', () => {
  describe('MBadge Management Component', () => {
    let comp: MBadgeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MBadgeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mBadges[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
