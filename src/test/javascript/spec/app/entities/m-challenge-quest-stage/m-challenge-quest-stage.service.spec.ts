...
describe('Service Tests', () => {
  describe('MChallengeQuestStage Service', () => {
    let injector: TestBed;
    let service: MChallengeQuestStageService;
    let httpMock: HttpTestingController;
    let elemDefault: IMChallengeQuestStage;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(MChallengeQuestStageService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new MChallengeQuestStage(
        0,
        0,
        0,
        'AAAAAAA',
    ...
    describe('Service methods', () => {
      ...
      it('should create a MChallengeQuestStage', async () => {
        ...
        service
          .create(new MChallengeQuestStage(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a MChallengeQuestStage', async () => {
        const returnedFromService = Object.assign(
          {
            worldId: 1,
            number: 1,
      ...
      it('should return a list of MChallengeQuestStage', async () => {
        const returnedFromService = Object.assign(
          {
            worldId: 1,
            number: 1,
      ...
      it('should delete a MChallengeQuestStage', async () => {
