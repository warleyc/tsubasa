...
import { MTeamComponent } from 'app/entities/m-team/m-team.component';
import { MTeamService } from 'app/entities/m-team/m-team.service';
import { MTeam } from 'app/shared/model/m-team.model';

describe('Component Tests', () => {
  describe('MTeam Management Component', () => {
    let comp: MTeamComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MTeamComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.mTeams[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
